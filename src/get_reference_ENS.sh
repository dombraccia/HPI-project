...
wget ftp://ftp.ensembl.org/pub/release-94/fasta/homo_sapiens/ncrna/Homo_sapiens.GRCh38.ncrna.fa.gz -P ../reference_data/
...
wget ftp://ftp.ensemblgenomes.org/pub/protists/release-41/fasta/plasmodium_falciparum/ncrna/Plasmodium_falciparum.EPr1.ncrna.fa.gz -P ../reference_data/
